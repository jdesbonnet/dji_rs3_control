...
To the best of my knowledge this protocol has not been documented anywhere else. This docementation has been achieve by reverse-engineering the protocol from 
bluetooth packet logs with the aid of OpenAI gpt-5.5. It is a work in progress. 

When reverse engineering the protocol the device firmware is version ? and the DJI Ronin app version ?.
